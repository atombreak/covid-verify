        ...
        <div className='w-full min-h-screen'>
            ...
            <div className='w-full flex content-center justify-around h-auto p-4 mt-4'>
                ...
                <div className='w-7/12 flex justify-around items-center bg-green-500'>
                    <QRCode value={props.url} size={180} background='#00ff00' level={'H'} renderAs="canvas"/>
                </div>
            </div>
            ...
            <p className='text-green-500 text-center font-bold text-lg'> This Covid Vaccination Certificate is valid and generated by All1Zed System on behalf of the Zambian Ministry of Health and it's Partners.</p>
