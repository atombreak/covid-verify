...
const Print = props => {
    return (
        <div className='w-full min-h-screen'>
            ...
            <p className='text-orange-400 text-center font-bold text-lg'> This Covid Vaccination Certificate is valid and generated by All1Zed System on behalf of the Zambian Ministry of Health and it's Partners.</p>
